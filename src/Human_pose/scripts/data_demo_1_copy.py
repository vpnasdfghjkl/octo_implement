...
src_path = "/media/rebot801/P1_LT1/dataset/100eef"
...
for file_path in os.listdir(src_path):
    try:
        ...
        command_path = f'{src_path}/{file_path}/command/{data_time}_command_processed_1.txt'

        stand_path = f'{src_path}/{file_path}/state/{data_time}_state_processed_1.txt'

        X_state = get_txt(stand_path)

        X_command = get_txt(command_path)
