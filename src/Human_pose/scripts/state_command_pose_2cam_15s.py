...
class MyKuavo(object):
    ...
    def unpickle_state(self, count_state, state_save_path):
        ...
        camera_path_1 = f'{state_save_path}/../camera1'
        camera_path_2 = f'{state_save_path}/../camera2'

        

        if not os.path.isdir(camera_path_1):
            os.makedirs(camera_path_1)

        if not os.path.isdir(camera_path_2):
            os.makedirs(camera_path_2)
        ...
        self.color_image1,self.color_image2 = self.get_image()

        camera_path1 = f'{state_save_path}/../camera1/{time.time()}.png'
        camera_path2 = f'{state_save_path}/../camera2/{time.time()}.png'
        
        cv2.imshow("color_img1", self.color_image1)
        #cv2.imshow("color_img2", self.color_image2)

        cv2.waitKey(1)
   
        cv2.imwrite(camera_path1, self.color_image1)
        cv2.imwrite(camera_path2, self.color_image2)
...
if __name__ == "__main__":
    ...
    file_names =   [f'/home/rebot801/LIuXin/Dataset/pure_bg2/{time_label}_Data/state',
                    f'/home/rebot801/LIuXin/Dataset/pure_bg2/{time_label}_Data/command',
                    f'/home/rebot801/LIuXin/Dataset/pure_bg2/{time_label}_Data/gripper',
                    f'/home/rebot801/LIuXin/Dataset/pure_bg2/{time_label}_Data/camera']
