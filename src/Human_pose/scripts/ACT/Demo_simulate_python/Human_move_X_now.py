    ...
    def get_RobotState_callback(self, msg):
        ...
        if status is True:
            ...
            if self.num == 1:
                ...
                # self.joint_position[7:14] = [4.992532024813661, -6.263071314672014, -70.9749008721895, -14.895579584650438, -0.6126341124607534, 1.0034179800226926, -0.006750051933921223]
                self.joint_position[7:14] = [4.390351267641567, -5.765140764817148, -66.48257761222652, -4.393502186584298, -0.6048223151822824, 1.7447309702466962, 0.02816286423351908]
                ...
                iamge_time = f"{time.time()}.png"
                image_name = os.path.join(image_path, iamge_time)
        ...
        try:
            ...
            if self.image is not None:
                ...
                if self.num == 1:
                    ...
                    target_right_list = main_ACT(cam_followed=camera_image, current_joints=right_list, End_status=End_status)
                    ...
                    # 第一阶段
                    if target_right_list[7] < 0.6 and End_status is False:
                    ...
                    # 合爪的阶段
                    elif target_right_list[7] > 0.8 and End_status is False:
                    ...
                    # 开爪的阶段
                    elif target_right_list[7] < 0.93 and End_status is True:
