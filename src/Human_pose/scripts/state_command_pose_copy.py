...
def main(file_names: list):
    ...
    Kuavoo = MyKuavo(queue_size=10, datalen=14,file_name=file_names)
    Kuavoo.openoffset()
...
if __name__ =="__main__":
    ...
    file_names = [f'/home/rebot801/LIuXin/ICCUB_ws/src/Human_pose/scripts/Dataset/{time_label}_Data/state', 
                  f'/home/rebot801/LIuXin/ICCUB_ws/src/Human_pose/scripts/Dataset/{time_label}_Data/command',
                  f'/home/rebot801/LIuXin/ICCUB_ws/src/Human_pose/scripts/Dataset/{time_label}_Data/gripper',
                  f'/home/rebot801/LIuXin/ICCUB_ws/src/Human_pose/scripts/Dataset/{time_label}_Data/camera']
    ...
    if status == 2:
        ...
        Get_camera = Thread(target=get_image)    
        Get_camera.setDaemon(True)
        Get_camera.start()
